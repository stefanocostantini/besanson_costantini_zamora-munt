...
# Get raw HTML 
link = 'http://www.amazon.com/King-Candy-Crush-Saga/product-reviews/B00FAPF5U0/ \
...
max_page = pages[-1].get_text() # get the max page
...
data.to_csv('ps1_ex4-reviews3.csv', encoding = 'utf-8', sep = '\t') # for tab-separated csv
